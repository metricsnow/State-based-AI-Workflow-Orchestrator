...
│   ├── prd_phase8.md            # Phase 8 PRD (Advanced Orchestration)
...
│   └── airflow-kafka-integration-guide.md  # Airflow-Kafka integration
├── kafka/                        # Kafka Documentation
│   ├── kafka-setup-guide.md     # Kafka infrastructure setup
│   ├── kafka-producer-guide.md  # Kafka producer usage guide
│   ├── kafka-consumer-guide.md  # Kafka consumer usage guide
│   └── event-schema-guide.md    # Event schema documentation
├── langgraph/                    # LangGraph Documentation
│   ├── langgraph-state-guide.md
│   ├── langgraph-conditional-routing-guide.md
│   ├── langgraph-checkpointing-guide.md
│   ├── langgraph-agent-nodes-guide.md
│   ├── langgraph-llm-nodes-guide.md
│   ├── langgraph-orchestrator-guide.md
│   ├── langgraph-multi-agent-workflow-guide.md
│   └── langgraph-kafka-integration-guide.md
├── llm/                          # LLM Integration Documentation
│   ├── langchain-ollama-integration-guide.md
│   ├── ollama-model-management-guide.md
│   ├── unified-llm-factory-guide.md
│   └── llm-test-optimization-guide.md
└── infrastructure/              # Infrastructure & Monitoring
    └── monitoring-setup-guide.md # Prometheus/Grafana monitoring
```

## Quick Links

### Getting Started
1. Read [Setup Guide](guides/setup-guide.md) for environment setup
2. Review [PRD Phase 1](prds/prd_phase1.md) for requirements
3. Check [Testing Guide](guides/testing-guide-phase1.md) for testing procedures

### Product Requirements
- **[Main PRD](prds/prd.md)** - Complete product requirements document
- **[Phase PRDs](prds/)** - Phase-specific requirements (Phases 1-9)
...
### Product Requirements
- **[PRD Phase 1](prds/prd_phase1.md)** - Foundation & Core Orchestration
...
### Setup and Testing
- **[Setup Guide](guides/setup-guide.md)** - Step-by-step environment setup instructions
- **[Testing Guide](guides/testing-guide-phase1.md)** - Comprehensive testing procedures
...
- **[TaskFlow API Guide](airflow/taskflow-api-guide.md)** - TaskFlow API implementation guide
...
- **[Event Schema Guide](kafka/event-schema-guide.md)** - Workflow event schema documentation
  - ✅ TASK-010: Event Schema Definition (Complete)
  - Pydantic models, validation, serialization, and JSON schema generation
- **[Kafka Producer Guide](kafka/kafka-producer-guide.md)** - Kafka producer usage and configuration
  - ✅ TASK-011: Kafka Producer Implementation (Complete)
  - Producer class, event publishing, error handling, connection management
- **[Kafka Consumer Guide](kafka/kafka-consumer-guide.md)** - Kafka consumer usage and configuration
  - ✅ TASK-012: Kafka Consumer Implementation (Complete)
  - Consumer class, event consumption, offset management, error handling
- **[Kafka Setup Guide](kafka/kafka-setup-guide.md)** - Kafka infrastructure setup
  - ✅ TASK-009: Kafka Docker Setup (Complete)
  - Zookeeper and Kafka configuration, troubleshooting
- **[Airflow-Kafka Integration Guide](airflow/airflow-kafka-integration-guide.md)** - Airflow-Kafka integration
...
- **[LangGraph State Guide](langgraph/langgraph-state-guide.md)** - LangGraph state definitions and reducers
...
- **[LangGraph Agent Nodes Guide](langgraph/langgraph-agent-nodes-guide.md)** - Specialized agent nodes for multi-agent workflows
...
- **[LangGraph LLM Nodes Guide](langgraph/langgraph-llm-nodes-guide.md)** - LLM nodes for AI-powered workflows
...
- **[LangGraph Orchestrator Guide](langgraph/langgraph-orchestrator-guide.md)** - Orchestrator agent for multi-agent coordination
...
- **[LangGraph Multi-Agent Workflow Guide](langgraph/langgraph-multi-agent-workflow-guide.md)** - Complete multi-agent workflow with StateGraph
...
- **[LangGraph Conditional Routing Guide](langgraph/langgraph-conditional-routing-guide.md)** - Conditional routing in LangGraph workflows
...
- **[LangGraph Checkpointing Guide](langgraph/langgraph-checkpointing-guide.md)** - Checkpointing with InMemorySaver
...
### LLM Integration
- **[LangChain LLM Integration Guide](llm/langchain-ollama-integration-guide.md)** - Unified LLM integration (Ollama and OpenAI)
...
- **[Ollama Model Management Guide](llm/ollama-model-management-guide.md)** - Ollama model download and validation
...
- **[LangGraph LLM Nodes Guide](langgraph/langgraph-llm-nodes-guide.md)** - LLM nodes for LangGraph workflows
  - ✅ TASK-034: Create LangGraph Node with Ollama LLM (Complete)
  ...
  - **CRITICAL**: All tests use production conditions - no mocks, no placeholders
- **[Unified LLM Factory Guide](llm/unified-llm-factory-guide.md)** - Unified LLM factory pattern
  - ✅ TASK-038: Unified LLM Factory with Model Toggle (Complete)
- **[LLM Test Optimization Guide](llm/llm-test-optimization-guide.md)** - LLM testing best practices

### LangGraph-Kafka Integration
- **[LangGraph Kafka Integration Guide](langgraph/langgraph-kafka-integration-guide.md)** - Async Kafka consumer for LangGraph workflows
...
- **[Monitoring Setup Guide](infrastructure/monitoring-setup-guide.md)** - Prometheus and Grafana monitoring
...
See [Testing Guide](guides/testing-guide-phase1.md) and [Test Suite README](../tests/README.md) for details.

## Contributing

When adding new documentation:
1. Follow existing documentation structure (use appropriate subfolder)
